  ...
  return (
    <div className="h-20 bg-custom-bg-header grid place-items-center px-2 shadow-black shadow-lg">
      <div className="container flex items-center justify-between">
        <div className="text-3xl sm:text-4xl font-bold">PunyUrl</div>
        <a href="https://github.com/CodingJury/puny-url" target="_blank" className="rounded-full hover:bg-custom-text/25">
